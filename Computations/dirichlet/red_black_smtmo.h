...
namespace dir2d
{
	...
	public:
		RedBlackTiledSmtmo(uint workgroupSizeX, uint workgroupSizeY, gl::Id programSt0, gl::Id programSt1);

		~RedBlackTiledSmtmo() = default;

		RedBlackTiledSmtmo(const RedBlackTiledSmtmo&) = delete;
		RedBlackTiledSmtmo& operator = (const RedBlackTiledSmtmo&) = delete;

		RedBlackTiledSmtmo(RedBlackTiledSmtmo&&) noexcept = delete;
		RedBlackTiledSmtmo& operator = (RedBlackTiledSmtmo&&) noexcept = delete;
