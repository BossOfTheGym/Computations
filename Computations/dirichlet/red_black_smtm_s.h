...
namespace dir2d
{
	...
	public:
		RedBlackTiledSmtmS(uint workgroupSizeX, uint workgroupSizeY, gl::ShaderProgram&& program);

		~RedBlackTiledSmtmS() = default;

		RedBlackTiledSmtmS(const RedBlackTiledSmtmS&) = delete;
		RedBlackTiledSmtmS& operator = (const RedBlackTiledSmtmS&) = delete;

		RedBlackTiledSmtmS(RedBlackTiledSmtmS&&) noexcept = delete;
		RedBlackTiledSmtmS& operator = (RedBlackTiledSmtmS&&) noexcept = delete;
