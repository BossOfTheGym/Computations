...
namespace dir2d
{
	...
	public:
		RedBlackTiledSmt(uint workgroupSizeX, uint workgroupSizeY, gl::ShaderProgram&& programSt0, gl::ShaderProgram&& programSt1);

		~RedBlackTiledSmt() = default;

		RedBlackTiledSmt(const RedBlackTiledSmt&) = delete;
		RedBlackTiledSmt& operator = (const RedBlackTiledSmt&) = delete;

		RedBlackTiledSmt(RedBlackTiledSmt&&) noexcept = delete;
		RedBlackTiledSmt& operator = (RedBlackTiledSmt&&) noexcept = delete;
	...
	private:
		...
		gl::ShaderProgram m_programSt0;
		gl::ShaderProgram m_programSt1;
		Uniforms m_uniforms;
